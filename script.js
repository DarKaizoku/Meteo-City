...
//const nomVille = document.getElementById('nomVille'); remplacer par sstitre dans le titre de page !
...
const ssTitre = document.getElementById('sstitre');
...
function affMeteo(data) {
    ...
    ssTitre.textContent = `${data.name}`;
    /* nomVille.textContent = `Actuellement, le climat de ${data.name} est :`; idem que pour la constante */
    ...
    humidity.textContent = `L'humidité de l'air est de ${data.main.humidity}%`;
...
//input.addEventListener('cuechange')
